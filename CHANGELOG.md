...
- Added support for the gold-standard Estonian Winogrande dataset. The split is given by
  1,024 / 256 / 1,767 samples for train / val / test, respectively. Train and val contain
  machine-translated data, while test is translated and adapted by hand.
